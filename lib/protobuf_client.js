...
(function() {
  ...
  ProtobufClient = (function(_super) {
    ...
    ProtobufClient.name = 'ProtobufClient';
    ...
    ProtobufClient.prototype.keys = function() {
      ...
      cb = function(err, data) {
        var chunk, key, result, _i, _j, _len, _len1;
        result = [];
        for (_i = 0, _len = data.length; _i < _len; _i++) {
          chunk = data[_i];
          for (_j = 0, _len1 = chunk.length; _j < _len1; _j++) {
            key = chunk[_j];
    ...
    ProtobufClient.prototype.runJob = function() {
      ...
      cb = function(err, data) {
        var elem, phase, result, _i, _len, _ref1;
        result = [];
        for (_i = 0, _len = data.length; _i < _len; _i++) {
          _ref1 = data[_i], phase = _ref1[0], elem = _ref1[1];
          if (!result[phase]) {
            result[phase] = [];
          }
