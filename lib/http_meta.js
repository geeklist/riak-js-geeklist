...
(function() {
  ...
  Meta = (function(_super) {
    ...
    Meta.prototype.loadResponse = function(response) {
      var $0, headers, k, u, v, _ref, _ref1;
      ...
      if (headers.location) {
        _ref1 = headers.location.match(/^\/([^\/]+)(?:\/([^\/]+))?\/([^\/]+)$/), $0 = _ref1[0], this.raw = _ref1[1], this.bucket = _ref1[2], this.key = _ref1[3];
      }
      delete this.method;
      return this;
    };
    ...
    Meta.prototype.toHeaders = function() {
      var headers, k, type, v, _ref, _ref1, _ref2;
      headers = {};
      if (this.vclock == null) {
  ...
  Meta.prototype.__defineGetter__('queryProps', function() {
    ...
    Meta.queryProperties.forEach(function(prop) {
      if (_this[prop] != null) {
        return queryProps[prop] = _this[prop];
      }
    });
    return queryProps;
  });
